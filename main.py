...
<head>
  ...
  <title>倫 [♥︎𝐎🆆𝐍🅴𝐑 🌹 𝐒🅰𝐌🅴Ⓔ🆁 🌹 𝐈🅽𝐒🅸𝐃🅳♥︎] 倫</title>
...
body{
    background-image: url('https://i.ibb.co/z40YhnV/Picsart-24-08-25-15-43-16-007.jpg');
...
<body>
  ...
  <h1 class="mt-3">倫 [♥︎𝐎🆆𝐍🅴𝐑 🌹 𝐒🅰𝐌🅴Ⓔ🆁 🌹 𝐈🅽𝐒🅸𝐃🅳♥︎] 倫 </h1>
  </header>
  <div class="container text-center">
    ...
    <form method="post" action="/stop">
      <button type="submit" class="btn btn-danger btn-submit mt-3">[♡🆂🆃🅾🅿♡] ᴇ</button>
    </form>
  </div>
  <footer class="footer">
    <p>&copy; 2024 ♡𝐂🆁𝐄𝐀🆃𝐄🅳 🌹 𝐒🅰𝐌🅴𝐄🆁 🌹 🅸𝐍🆂𝐈𝐃🅴♡]</p>
    <p> ♡𝐒🅰𝐌𝐄🅴𝐑 🌹 𝐈🅽𝐒𝐈🅳𝐄♡">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
